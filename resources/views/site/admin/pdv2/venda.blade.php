    ...
    <div class="d-flex justify-content-center align-items-center row">
            ...
            <div class="d-flex justify-content-center col-md-10 row">
                <div class="d-flex justify-content-center col-md-3 bg-white border border-primary rounded-pill">
                    <form class="col-md-11" id="add-produto" action="{{ route('admin.pdv.add-produto') }}" method="POST">
                        ...
                        <input type="hidden" name="local_id" value="5">
                    ...
                    <div style="font-size: 20px;" class="d-flex justify-content-center col-md-12">
                        <form id="concluir" class="d-flex justify-content-center flex-wrap" action="{{ route('admin.pdv.concluir-venda') }}" method="POST">
                            ...
                            <div class="justify-content-center col-md-12" id="div_dinheiro" style="padding: 3px;">
                                <input type="text" style="margin: 0px;height: 2em;font-size: 25px;" class="form-control form-control-border border-width-2 col-md-4" id="input-dinheiro" name="dinheiro" placeholder="R$0.00" onkeypress="return event.charCode >= 48 && event.charCode <= 57 || event.charCode == 13 || event.charCode == 44" maxlength="7">
                                <input type="text" style="margin: 0px;height: 2em;font-size: 25px;" class="form-control form-control-border border-width-2 col-md-4" id="input-troco" name="troco" placeholder="Troco" readonly>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        @if (count($carrinho) == 0)
            <div class="d-flex justify-content-center col-10 mt-1">
                <form class="col-12" action="{{ route('admin.pdv2.delete') }}" method="POST">
                    @csrf
                    <input type="hidden" name="venda_id" value="{{ Request::segment(4) }}">
...
@section('js')
    <script>
        function imprimir(){
            ...
            let aba = window.open("http://localhost:8989/admin/pdv2/venda/imprimir/"+venda)
            setTimeout(function(){
                aba.print()
            }, 0250);
            setTimeout(function(){
        ...
        function calcular() {
            ...
            var n2 = parseFloat(document.getElementById('input-total').value, 4,2);
