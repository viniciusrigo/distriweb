    ...
    <div class="d-flex row">
        <nav class="d-flex align-items-center col-md-6">
            <ol class="breadcrumb col-md-12 p-3 m-2">
                ...
                <li class="breadcrumb-item active" aria-current="page">Criar Combo</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="card-body">
            <div class="d-flex justify-content-center row alert-warning show p-2 rounded">
                <div class="d-flex justify-content-center col-md-12">
                    <span>Dica nome combo: <strong>Nome Combo: "Combo" "Item Principal" - Variavel Nome: "/" "Quantidade" "Produto" "/" "Quantidade" "Produto" </strong></span>
                </div>
                <div class="d-flex justify-content-center col-md-12">
                    <span>Ex: <strong>Combo Red Label / 2 Agua de Coco / 4 Red Bull</strong></span>
                </div>
            </div>
            <form class="d-flex justify-content-center form-row" action="{{ route('admin.estoque.produtos.store-combo') }}" method="POST">
                @csrf
                ...
                <div class="form-group col-md-1" style="padding: 3px;">
                    ...
                    <select id="categoria_id" style="margin: 0px;" class="custom-select form-control-border border-width-2" id="categoria_id" name="categoria_id" required>
                        <option value="{{ $categorias[4]->id }}">{{ $categorias[4]->nome }}</option>
                    </select>
                </div>

                <div class="d-flex justify-content-center form-group col-md-12"><strong style="color: #007BFF;">Variáveis</strong></div>
                <div class="d-flex justify-content-center col-md-12">
                    <div class="form-group col-md-2" style="padding: 3px;">
                ...
                <div class="top col-md-12">
                    <div class="principal d-flex justify-content-center col-md-12">
                        <div class="form-group col-md-2" style="padding: 3px;">
                            <label style="margin: 0px;">Produto</label>
                ...
                <div class="d-flex justify-content-center col-md-12">
                    <button id="variavel" class="btn btn-primary" type="button">+ Produto</button>
                </div>
