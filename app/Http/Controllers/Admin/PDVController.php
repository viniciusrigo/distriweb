...
class PDVController extends Controller
{
    ...
    public function page_index(){
        ...
        $venda = Venda::where("status", "=", "a")->where("local_id", 4)->get();
        if(count($venda) > 0){
    ...
    public function page_sale(){
        ...
        if ($quantidade > 0) {
            ...
            return view("site/admin/pdv/venda", compact("venda", "carrinho", "produtos"));
    ...
    public function imprimir_venda(string|int $id){
        ...
        return view("site/admin/pdv/imprimir", compact("produtos_pdv", "venda", "info_empresa"));
    }
